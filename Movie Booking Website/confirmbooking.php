...
$query ="select * from movie where Title='".$titlep."'";
...
<div class="container" style="margin: 0 auto">
  <form method="post" action="update_db.php">
	...
	$query="INSERT INTO people VALUES ('".$usernamedb."','".$title."','".$time."','".$_POST['number']."','RESERVED')";
	...
	<?php
	echo '<button type="submit" name="confirm" value="'.$title.'" >Confirm</button>';
	?>
	</form>
	...
	echo '<button type="submit" name="cancel" value="cancel" onclick="mainLandingPage_customer.php" >Cancel</button>';
	?>
	</form>
